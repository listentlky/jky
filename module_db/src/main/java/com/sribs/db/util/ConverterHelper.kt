...
object  ConverterHelper {
    ...
    fun covertProjectBean(b:com.sribs.common.bean.db.ProjectBean):ProjectBean
            = ProjectBean(
        name   = b.name,
        leader = b.leader,
        builderNo = b.buildNo,
    ...
    fun convertUnitBean(b:com.sribs.common.bean.db.UnitBean):UnitBean
            = UnitBean(
        projectId = b.projectId,
        bldId = b.bldId,
        unitNo = b.unitNo,
    ...
    fun convertConfigBean(b: com.sribs.common.bean.db.ConfigBean):ConfigBean
            = ConfigBean(
        projectId = b.projectId,
        bldId = b.bldId,
        unitId = b.unitId,
...
//            it.floorNum = Util.formatZeroNum(b.floorNum)
    ...
    fun convertReportBean(b:com.sribs.common.bean.db.ReportBean):ReportBean
            = ReportBean(
        projectId = b.projectId,
        unitId = b.unitId,
        configId = b.configId,
    ...
    fun convertUserBean(b:com.sribs.common.bean.db.UserBean):UserBean
            = UserBean(
        b.name,
        b.account,
        b.password,
    ...
    fun convertLeaderBean(b:com.sribs.common.bean.db.LeaderBean):LeaderBean
            = LeaderBean(
        b.name,
    ).also {
        if (!b.id.isNullOrEmpty()){
    ...
    fun convertBuildingBean(bb: com.sribs.common.bean.db.BuildingBean): BuildingBean
        = BuildingBean(
        bb.projectId,
        bb.bldName,
        bb.bldType,
    ...
    fun convertFloorBean(fb: com.sribs.common.bean.db.FloorBean): FloorBean
            = FloorBean(
        fb.projectId,
        fb.bldId,
        fb.unitId,
    ...
    fun convertDrawingBean(dw: com.sribs.common.bean.db.DrawingBean): DrawingBean
            = DrawingBean(
        dw.projectId,
        dw.bldId,
        dw.unitId,
    ...
    fun convertDbDrawingBeanToCommon(dw: Maybe<List<com.sribs.db.project.drawing.DrawingBean>>): Maybe<List<com.sribs.common.bean.db.DrawingBean>>
        = dw.map { it.map { b->com.sribs.common.bean.db.DrawingBean(
        b.id,
        b.projectId,
        b.bldId,
        b.unitId,
    ...
    fun convertDbDamageBeanToCommon(dm: Flowable<List<com.sribs.db.project.damage.DamageBean>>): Flowable<List<com.sribs.common.bean.db.DamageBean>>
        = dm.map { it.map { b->com.sribs.common.bean.db.DamageBean(
            b.drawingId,
            b.dTypeName,
            b.annotRef,
            b.axis,

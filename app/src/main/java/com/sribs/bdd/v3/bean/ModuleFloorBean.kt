...
//楼层
data class ModuleFloorBean(val floorId:String,var name: String, var pictureList: ArrayList<ModuleFloorPictureBean>?,var floor:String?,var floorType:Int,var floorIndex:Int)

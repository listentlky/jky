 ...
 * @Description
 */
class ProjectConfigBottomFloorDataBean:ProjectConfigBaseDataBean() {
    override fun getThis(): com.sribs.common.bean.BaseDataBean = this
    override fun toString(): String {
        return "ProjectConfigBottomFloorDataBean(type=$type, floorNum='$floorNum', corridorNum='$corridorNum', corridorConfig='$corridorConfig', platformNum='$platformNum', platformConfig='$platformConfig')"
    }

    override val type: UnitConfigType = UnitConfigType.CONFIG_TYPE_FLOOR_BOTTOM
    ...
    override fun copy(): ProjectConfigBaseDataBean? =
        ProjectConfigBottomFloorDataBean().also { it.setData(this) }

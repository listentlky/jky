...
import com.sribs.bdd.databinding.ItemNoinTableFloorDetailBinding
 ...
 * @Description
 */
class FloorLayout:BaseConfigLayout {

    private var mBinding: ItemNoinTableFloorDetailBinding?=null

    private var mDrawingList: ArrayList<String>?=null
...
//            mBinding?.unitFloorName?.text = mFloorStr
    ...
    override fun initView() {
        mBinding = ItemNoinTableFloorDetailBinding.inflate(LayoutInflater.from(context),this,true)
    }

    override fun copyBtnView(): View? = mBinding?.tvFloorCopy

//    override fun hasDataView(): View? = mBinding?.unitFloorName
    override fun hasDataView(): View? = mBinding?.tvUploadDrawing

    override fun publicFloorView(): View? = mBinding?.tvDrawings
...
//
//    }
    constructor(c:Context,parentHashCode:String,number:String,bCopy:Boolean,drawingList:ArrayList<String>?=null) : super(c) {
        this.mFloorNum = number
        this.bCopy = bCopy// and has Data 与数据
        this.neighborSize = neighborSize
//        this.mCb = cb

//        mBinding?.tvUploadDrawing?.setOnClickListener {
//            LOG.I("leon","tvUploadDrawing click mCb=$mCb")
//            mCb?.onDrawingsChangeClick(
//                this.mFloorNum
//            )
//        }
//        mBinding?.tvFloorCopy?.setOnClickListener {
//            LOG.I("leon","unitFloorCopy click mCb=$mCb")
...
//        val parent = mBinding?.tvDrawings

...
class DatabaseSrv:IDatabaseService {
    ...
    override fun getProjectOnce(name: String, buildNo: String): Single<List<ProjectBean>> {
        var dao = mDb!!.projectDao()
        return dao.getProjectOnce(name,buildNo).run { ConverterHelper.convertProjectBeanOnce(this) }
    }
    ...
    override fun updateProject(b: ProjectBean): Observable<Long>
            = Observable.create {
        var dao = mDb!!.projectDao()
        it.onNext(dao.insertProject(ConverterHelper.covertProjectBean(b)))
    }

    override fun deleteProject(b: ProjectBean): Observable<Int>
            = Observable.create {
        var dao = mDb!!.projectDao()
    ...
    override fun getAllUnitOnce(projectId: Long): Single<List<com.sribs.common.bean.db.UnitBean>> {
        var dao = mDb!!.unitDao()
        return dao.getUnitByProjectIdOnce(projectId).run { ConverterHelper.convertUnitBeanOnce(this) }
    }
    ...
    override fun updateConfig(b: com.sribs.common.bean.db.ConfigBean): Observable<Long> = Observable.create {
    ...
    override fun getConfigOnce(unitId: Long, floorIdx: Int): Single<List<com.sribs.common.bean.db.ConfigBean>> {
        var dao = mDb!!.configDao()
        return dao.getConfigByUnitFloorOnce(unitId,floorIdx).run { ConverterHelper.convertConfigBeanOnce(this) }
    }
    ...
    override fun getHouseStatusByUnitOnce(unitId: Long): Single<List<HouseStatusBean>> {
        var dao = mDb!!.houseStatusDao()
        return dao.getHouseStatusByUnitOnce(unitId).run {  ConverterHelper.convertHouseStatusBeanOnce(this) }
    }

    override fun getHouseStatusByProjectOnce(projectId: Long): Single<List<HouseStatusBean>> {
        var dao = mDb!!.houseStatusDao()
        return dao.getHouseStatusByProjectOnce(projectId).run {  ConverterHelper.convertHouseStatusBeanOnce(this) }
    }

    override fun getHouseStatus(configId: Long): Flowable<List<HouseStatusBean>> {
        var dao = mDb!!.houseStatusDao()
        return dao.getHouseStatusByConfig(configId).run { ConverterHelper.convertHouseStatusBean(this) }
    }

    override fun getHouseStatusByConfigOnce(configId: Long): Single<List<HouseStatusBean>> {
        var dao = mDb!!.houseStatusDao()
        return dao.getHouseStatusByConfigOnce(configId).run { ConverterHelper.convertHouseStatusBeanOnce(this) }
    }
    ...
    override fun deleteHouseStatusByProject(projectId: Long): Observable<Boolean> = Observable.create {
        var dao = mDb!!.houseStatusDao()
    ...
    override fun deleteHouseStatusByConfig(configId: Long): Observable<Boolean> = Observable.create {
        var dao = mDb!!.houseStatusDao()
    ...
    override fun getRoomStatus(configId: Long): Flowable<List<RoomStatusBean>> {
        ...
        return dao.getRoomStatusByConfig(configId).run { ConverterHelper.convertRoomStatusBean(this) }
    }

    override fun getRoomStatus(configId: Long, name: String): Flowable<List<RoomStatusBean>> {
        var dao = mDb!!.roomStatusDao()
        return dao.getRoomStatusByConfig(configId,name).run { ConverterHelper.convertRoomStatusBean(this) }
    }

    override fun getRoomStatusOnce(configId: Long, name: String): Single<List<RoomStatusBean>> {
        var dao = mDb!!.roomStatusDao()
        return dao.getRoomStatusByConfigOnce(configId,name).run { ConverterHelper.convertRoomStatusOnce(this) }
    }

    override fun getRoomStatusOnce(configId: Long): Single<List<RoomStatusBean>> {
        var dao = mDb!!.roomStatusDao()
        return dao.getRoomStatusByConfigOnce(configId).run { ConverterHelper.convertRoomStatusOnce(this) }
    }

    override fun getRoomStatusByUnitOnce(unitId: Long): Single<List<RoomStatusBean>> {
        var dao = mDb!!.roomStatusDao()
        return dao.getRoomStatusByUnitOnce(unitId).run { ConverterHelper.convertRoomStatusOnce(this) }
    }
    ...
    override fun deleteRoomStatusByProject(projectId: Long): Observable<Boolean> = Observable.create {
        var dao = mDb!!.roomStatusDao()
    ...
    override fun deleteRoomStatusByConfig(configId: Long, name: String): Observable<Boolean> =  Observable.create  {
        var dao = mDb!!.roomStatusDao()
    ...
    override fun getRoomDetail(configId: Long): Flowable<List<RoomDetailBean>> {
        var dao = mDb!!.roomDetailDao()
        return dao.getRoomDetailByConfig(configId).run { ConverterHelper.convertRoomDetailBean(this) }
    }

    override fun getRoomDetail(configId: Long, name: String): Flowable<List<RoomDetailBean>> {
        var dao = mDb!!.roomDetailDao()
        return dao.getRoomDetailByRoom(configId,name).run { ConverterHelper.convertRoomDetailBean(this) }
    }

    override fun getRoomDetailOnce(configId: Long): Single<List<RoomDetailBean>> {
        var dao = mDb!!.roomDetailDao()
        return dao.getRoomDetailByConfigOnce(configId).run { ConverterHelper.convertRoomDetailBeanOnce(this) }
    }

    override fun getRoomDetailOnce(configId: Long, name: String): Single<List<RoomDetailBean>> {
        var dao = mDb!!.roomDetailDao()
        return dao.getRoomDetailByRoomOnce(configId,name).run { ConverterHelper.convertRoomDetailBeanOnce(this)  }
    }
    ...
    override fun getRoomDetailOnce(
        ...
        return if (damagePath.contains("其他损伤")){
            ...
            dao.getRoomDetailOtherByPath(configId,name,damagePath).run { ConverterHelper.convertRoomDetailBeanOnce(this) }
        }else{
            LOG.I("123","search normal  $damagePath")
            dao.getRoomDetailByPath(configId,name,damagePath).run { ConverterHelper.convertRoomDetailBeanOnce(this) }
        }
    ...
    override fun getRoomDetailOnce(
        ...
        var dao = mDb!!.roomDetailDao()
        return dao.getRoomDetailByPath(configId,name,damagePath,damageIdx).run { ConverterHelper.convertRoomDetailBeanOnce(this) }
    }
    ...
    override fun getRoomDetailOnce(
        ...
        var dao = mDb!!.roomDetailDao()
        return dao.getRoomDetailByDescription(configId,name,damagePath,des).run { ConverterHelper.convertRoomDetailBeanOnce(this) }
    }


    override fun getRoomDetailByUnitOnce(unitId: Long): Single<List<RoomDetailBean>> {
        var dao = mDb!!.roomDetailDao()
        return dao.getRoomDetailByUnitOnce(unitId).run { ConverterHelper.convertRoomDetailBeanOnce(this) }
    }
    ...
    override fun deleteRoomDetailByProject(projectId: Long): Observable<Boolean> = Observable.create {
        var dao = mDb!!.roomDetailDao()
    ...
    override fun deleteRoomDetailByConfig(configId: Long,name:String): Observable<Boolean> = Observable.create {
        var dao = mDb!!.roomDetailDao()
...
//        it.onNext(dao.updateProject(ConverterHelper.convertProjectBean(b)).toLong())
    ...
    override fun getLocalDrawingListInBuilding(proId:Long, bldId:Long): Maybe<List<com.sribs.common.bean.db.DrawingBean>> {
        var dao = mDb!!.drawingDao()
        return dao.getLocalDrawingListInBuilding(proId, bldId).run { ConverterHelper.convertDbDrawingBeanToCommon(this) }
    }
    ...
    override fun getLocalDamageListInDrawing(drwingId:Long): Flowable<List<com.sribs.common.bean.db.DamageBean>> {
        ...
        return dao.getDamageByDrawingId(drwingId).run { ConverterHelper.convertDbDamageBeanToCommon(this) }
    }
    ...
    override fun getDrawingByProjectId(prjId: Long): Flowable<List<com.sribs.common.bean.db.DrawingBean>>{
        var dao = mDb!!.drawingDao()
        return dao.getDrawingByProjectId(prjId).run { ConverterHelper.convertDbDrawingBeanToCommonFlow(this) }

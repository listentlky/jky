...
public class PDFGLViewAct extends Activity implements ILayoutView.PDFLayoutListener
{
	...
	@Override
	public void onPDFNoteTapped(String jstr) {
		Log.i("leon", "PDFGLViewAct OnPDFNoteTapped");
	}

	@Override
	public void onPDFNoteAdded(String annotPoint) {

	}

	@Override
	public void onPDFNoteEdited(String annotPoint) {

	}

	@Override
	public void onPDFNoteDeleted(String annotPoint) {

 ...
 * @Description
 */
class ProjectConfigNormalNeighborDataBean:ProjectConfigBaseDataBean() {

    override val type: UnitConfigType=UnitConfigType.CONFIG_TYPE_UNIT_NORMAL
    ...
    override fun copy(): ProjectConfigBaseDataBean? =
        ProjectConfigNormalNeighborDataBean().also { it.setData(this) }
}